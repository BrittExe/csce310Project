...
CREATE TABLE `College_Student` (
  ...
  `Minor2` varchar(25) DEFAULT NULL,
...
INSERT INTO `College_Student` (`UIN`, `Gender`, `Hispanic/Latino`, `Race`, `US_Citizen`, `First_Generation`, `DoB`, `GPA`, `Major`, `Minor1`, `Minor2`, `Expected_Graduation`, `School`, `Classification`, `Phone`, `Student_Type`) VALUES
...
(1, '', '', '', 'Britt', '', 'College Student', 'brittschiller@tamu.edu', '', 0),
(2, 'Ryan', '', 'Kutz', 'ryan', 'password', 'College Student', 'ryandkutz@tamu.edu', '', 0);
...
INSERT INTO `College_Student` (`UIN`, `Gender`, `Hispanic/Latino`, `Race`, `US_Citizen`, `First_Generation`, `DoB`, `GPA`, `Major`, `Minor1`, `Minor2`, `Expected_Graduation`, `School`, `Classification`, `Phone`, `Student_Type`) VALUES (NEW.UIN, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
END IF
$$
DELIMITER ;
DELIMITER $$
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `Total_College_Student`  AS SELECT `User`.`UIN` AS `UIN`, `User`.`First_Name` AS `First_Name`, `User`.`M_Initial` AS `M_Initial`, `User`.`Last_Name` AS `Last_Name`, `User`.`Username` AS `Username`, `User`.`Passwords` AS `Passwords`, `User`.`User_Type` AS `User_Type`, `User`.`Email` AS `Email`, `User`.`Discord_Name` AS `Discord_Name`, `User`.`Is_Deleted` AS `Is_Deleted`, `College_Student`.`Gender` AS `Gender`, `College_Student`.`Hispanic/Latino` AS `Hispanic/Latino`, `College_Student`.`Race` AS `Race`, `College_Student`.`US_Citizen` AS `US_Citizen`, `College_Student`.`First_Generation` AS `First_Generation`, `College_Student`.`DoB` AS `DoB`, `College_Student`.`GPA` AS `GPA`, `College_Student`.`Major` AS `Major`, `College_Student`.`Minor1` AS `Minor1`, `College_Student`.`Minor2` AS `Minor2`, `College_Student`.`Expected_Graduation` AS `Expected_Graduation`, `College_Student`.`School` AS `School`, `College_Student`.`Classification` AS `Classification`, `College_Student`.`Phone` AS `Phone`, `College_Student`.`Student_Type` AS `Student_Type` FROM (`User` join `College_Student` on(`User`.`UIN` = `College_Student`.`UIN`)) ;
...
--
ALTER TABLE `User`
  MODIFY `UIN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
