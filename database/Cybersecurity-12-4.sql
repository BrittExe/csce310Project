...
--
-- Host: localhost
-- Generation Time: Dec 05, 2023 at 04:21 AM
...
(14, 'M', 0x46, 'Race', 0x54, 0x54, '2023-11-29', 3.5, 'Computer Science', 'Cybersecurity', NULL, 2023, 'EN', 'U4', 519, 'newtype'),
...
(14, 'Tester', 'B', 'Testee', 'Test', 'letsTest', 'College Student', 'test@tamu.edu', 'test_name', 0),
(18, 'adman', 'g', 'manad', 'Admin3', 'Admin3', 'Admin', 'admining@tamu.edu', 'adminguy#34', 0),
(19, 'hi', '', '', 'Apples', 'Watch', 'College Student', '', '', 1);
...
--
ALTER TABLE `College_Student`
  MODIFY `UIN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
