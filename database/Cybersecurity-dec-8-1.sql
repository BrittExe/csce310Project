...
(20, 'M', 0x46, 'White', 0x54, 0x54, '2002-03-12', 3.5, 'Computer Science', 'Cybersecurity', 'German', 2024, 'EN', 'U4', 892, 'College Student'),
(21, 'F', 0x46, 'White', 0x54, 0x54, '2001-04-12', 3.6, 'Computer Science', 'Cybersecurity', 'English', 2025, 'EN', 'U3', 123, 'College Student'),
(23, 'F', 0x46, 'White', 0x54, 0x46, '2003-04-15', 3.2, 'Computer Science', 'Cybersecurity', NULL, 2024, 'EN', 'U3', 713, 'College Student'),
(25, 'M', 0x46, 'White', 0x54, 0x54, '2000-09-22', 3.7, 'Computer Science', 'Cybersecurity', NULL, 2024, 'EN', 'U3', 312, 'College Student'),
(26, 'F', 0x46, 'White', 0x54, 0x54, '2000-07-23', 3.4, 'Computer Science', 'Cybersecurity', NULL, 2024, 'EN', 'U3', 456, 'College Student');
...
(12, 'Howdy', '', '', 'Admin', 'Admin', 'Admin', '', '', 0),
(13, 'name', '', '', 'Admin2', 'Admin2', 'Admin', '', '', 0),
(18, 'adman', 'g', 'manad', 'Admin3', 'Admin3', 'Admin', 'admining@tamu.edu', 'adminguy#34', 1),
(20, 'testUser', 'G', 'Guy', 'Hi', 'Super', 'College Student', 'superuser@tamu.edu', 'discord#4455', 0),
(21, 'Jane', 'g', 'Joe', 'JaneJoe', 'JoeJane', 'College Student', 'JaneJane@cse.tamu.edu', 'jj#5678', 1),
(22, 'Joe', 'f', 'Adam', 'pie', 'ne', 'Admin', 'adampi@tamu.edu', 'pi#1234', 0),
(23, 'name', 'f', 'lname', 'hello', 'goodday', 'College Student', 'never@tamu.edu', 'ever#3314', 1),
(24, 'gus', 'g', 'time', 'timeLord', 'pass', 'Admin', 'tl@tamu.edu', 'tl#3345', 0),
(25, 'appleseed', 'j', 'johnny', 'apple', 'lover', 'College Student', 'grape@tamu.edu', 'apple#1256', 1),
(26, 'Jane', 'J', 'Hoss', 'jojo', 'jojo', 'College Student', 'ojoj@tamu.edu', 'jojo#4341', 1),
(27, 'thomas', 'm', 'engine', 'thomas', 'thomas', 'Admin', 'thomas@tamu.edu', 'thomas#3321', 0);
...
--
ALTER TABLE `College_Student`
  MODIFY `UIN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `User`
  MODIFY `UIN` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
